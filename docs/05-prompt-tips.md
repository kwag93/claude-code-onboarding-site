...
!!! example "좋은 프롬프트의 공통점"
    **나쁜 예**: "로그인 기능 만들어줘"
    **좋은 예**: "JWT 기반 로그인 API 만들어줘. refresh token 포함, 기존 User 모델 활용, /api/v1/auth 경로로."
    차이는 **구체적인 맥락**이에요. 컨텍스트가 많을수록 결과가 정확합니다.
...
- [03. 실무 워크플로우](./03-workflows.md)에서 이 요령들을 실제 개발에 적용해보세요
- [15. CLAUDE.md 마스터리](./15-claude-md-mastery.md)에서 반복되는 프롬프트를 CLAUDE.md에 녹여 자동화하세요
