...
Claude Code를 제대로 쓰고 싶다면, 좋은 자료를 알고 있는 게 경쟁력이에요. 공식 문서부터 커뮤니티 팁까지, 실전에서 검증된 자료만 모았습니다.
...
!!! tip "이 가이드를 처음 보신다면"
    아직 환경 설정을 안 했다면 [01. 빠른 시작 가이드](./01-quick-start.md)부터 시작하세요. 이미 쓰고 있다면 [13. 파워유저 팁](./13-power-user-tips.md)에서 바로 생산성을 올릴 수 있어요.
